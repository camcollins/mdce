...
<div class="content-primary" data-theme="c">
    ...
    <div class="box-bottom-border card" style="text-align:center;">
        ...
        <a href="<?php echo bloginfo('siteurl'); ?>/maps2"><img src="<?php echo bloginfo('template_directory'); ?>/images/buttons/maps.png"/></a>
    </div>
    <div>
 ...
 <div id="SliderName">
		<a href="#"><img src="<?php echo bloginfo('template_directory'); ?>/images/buttons/sponsors/adp.png" alt="ADP" /></a>
       <a href="#"><img src="<?php echo bloginfo('template_directory'); ?>/images/buttons/sponsors/ari.png" alt="ARI" /></a>
       <a href="#"><img src="<?php echo bloginfo('template_directory'); ?>/images/buttons/sponsors/forestriver.png" alt="Forest River"/></a>
       <a href="#"><img src="<?php echo bloginfo('template_directory'); ?>/images/buttons/sponsors/manheim.png" alt="Manheim" /></a>
       <a href="#"><img src="<?php echo bloginfo('template_directory'); ?>/images/buttons/sponsors/regal.png" alt="Regal" /></a>
       <a href="#"><img src="<?php echo bloginfo('template_directory'); ?>/images/buttons/sponsors/volvo.png" alt="Volvo" /></a>
    </div>
