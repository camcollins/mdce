...
<div data-role="content">
    ...
    <div data-role="content" data-theme="b">
        <div style="float:left; margin-top:50px; margin-left:15%; width:70%;" id="sharebuttons">
	        <div class="navgroup">
	        	<a href="<?php echo bloginfo('siteurl'); ?>"><img src="<?php echo bloginfo('template_directory'); ?>/images/fb-share.png"/></a>
	        	<a href="<?php echo bloginfo('siteurl'); ?>"><img src="<?php echo bloginfo('template_directory'); ?>/images/tweet.png"/></a>
	        </div>

            <p><a href="https://twitter.com/intent/tweet?hashtags=MDCE&original_referer=<?php echo urlencode($_SERVER['HTTP_REFERER']); ?>&related=boatingindustry&source=tweetbutton&text=2012%20Marine%20Dealer%20Conference%20%26%20Expo&url=<?php echo urlencode($_SERVER['HTTP_REFERER']); ?>&via=boatingindustry" data-role="button" data-theme="b">Post on Twitter</a></p>
            <p><a href="http://m.facebook.com/sharer.php?u=<?php echo urlencode($_SERVER['HTTP_REFERER']); ?>" data-role="button" data-theme="b">Share on Facebook</a></p>
            <br><br><br>
