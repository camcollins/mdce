...
?>
		...
		<div style="float:left; margin-left:10%; margin-top:40px;">
        	<img src="<?php echo bloginfo('template_directory'); ?>/images/<?php echo $rs['image']; ?>" height="180" width="180" border="0" />
        </div>
	...
	else if($_GET['type'] == "exhibitor")
	{
		...
		while($rs=mysql_fetch_array($qry))
		{
			...
			<div style="float:left; margin-left:10%; margin-top:40px;">
             <?php 	if($rs['image']!="") {	?>
				<img src="<?php echo bloginfo('template_directory'); ?>/images/<?php echo $rs['image']; ?>" height="130" width="130" />
                <?php } ?>
			</div>
	...
	else if($_GET['type'] == "sponsors")
	{
		...
		?>
            ...
            <div style="float:left; margin-left:10%; margin-top:40px;">
            <?php 	if($rs['image']!="") {	?>
                <img src="<?php echo bloginfo('template_directory'); ?>/images/sponsors/<?php echo $rs['image']; ?>" height="130" width="130" />
                <?php } ?>
            </div>
            ...
            <div style="margin-top:30px;"></div>
            <p><a href="<?php echo bloginfo('siteurl'); ?>/sponsors" data-direction="reverse" data-role="button" data-theme="b" rel="external" style="margin-left: 0.5em; margin-right: 0.5em;">Back</a></p>
             <p>
            <?php
			if(isset($_SESSION['user_id']) && $_SESSION['user_id'] != "")
			{
