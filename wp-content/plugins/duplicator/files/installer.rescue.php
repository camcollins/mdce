...
$GLOBALS["SERIAL_TABLES"]["wp_3grfaw_options"]  = array('column_id' => 'option_id',  'column_value' => 'option_value');
$GLOBALS["SERIAL_TABLES"]["wp_3grfaw_postmeta"] = array('column_id' => 'meta_id',    'column_value' => 'meta_value');													 
$GLOBALS["SERIAL_TABLES"]["wp_3grfaw_usermeta"] = array('column_id' => 'umeta_id',    'column_value' => 'meta_value');
...
<div id="content">
	...
	if ($action == 'process') {
		...
		dinstaller_log("secure build name: 50a07d9cc06616266_20121112_2012marinedealerconferenceandex");
		dinstaller_log("----------------------------------");
		...
		if ($table_count == 0) {
			...
			table prefix 'wp_3grfaw_' is correct for this particular version of WordPress. \n");
		}
		
		//Update site title
		$site_title = mysqli_real_escape_string($mysqli_conn, $_POST['site_title']);
		mysqli_query($mysqli_conn, "UPDATE `wp_3grfaw_options` SET option_value = '{$site_title}' WHERE option_name = 'blogname' ");
		...
		mysqli_query($mysqli_conn, "DELETE FROM `wp_3grfaw_duplicator`");
		mysqli_query($mysqli_conn, "DELETE FROM `wp_3grfaw_options` WHERE `option_name` LIKE ('_transient%')");
		mysqli_query($mysqli_conn, "DELETE FROM `wp_3grfaw_options` WHERE `option_name` LIKE ('_site_transient%')");
		...
		$currdata = parse_url("http://mdce.dockmaster.com"); 
		...
		<form id="form-installer" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" >
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="2" class="table-inputs">
				...
				<tr valign="top">
					...
					<td>
						<input type="text" name="current_url" id="current_url" value="http://mdce.dockmaster.com" readonly="true"  class="readonly" />
				...
				<tr>
					<td>Site Title</td>
					<td><input type="text" name="site_title" id="site_title" value="2012 Marine Dealer Conference and Expo" /></td>
				</tr>
			</table><br/>
